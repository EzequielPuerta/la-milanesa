...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_svelte_share_buttons_component: string;
	export const GNOME_DESKTOP_SESSION_ID: string;
	export const npm_package_devDependencies_prettier_plugin_tailwindcss: string;
	export const npm_package_dependencies_plotly_js_dist: string;
	...
	export const npm_package_dependencies_d3_array: string;
	export const npm_package_dependencies_d3_color: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_svelte_share_buttons_component: string;
		GNOME_DESKTOP_SESSION_ID: string;
		npm_package_devDependencies_prettier_plugin_tailwindcss: string;
		npm_package_dependencies_plotly_js_dist: string;
		PATH: string;
		...
		npm_package_dependencies_d3_array: string;
		npm_package_dependencies_d3_color: string;
